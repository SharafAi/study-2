...
if (req.url === '/') {  
  ...
  res.write('<input type="text" name="username" placeholder="enter your name"><br>');//3
  
  res.write('<label for="male"> male </label>') //4
  res.write('<input type="radio" id = "male" name= "gender" value = "male" />'); //5
  res.write('<label for="female"> female </label>'); //6
  res.write('<input type="radio" id = "female" name= "gender" value = "female" />'); //7
